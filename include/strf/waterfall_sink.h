...
#ifndef INCLUDED_STRF_WATERFALL_SINK_H
#define INCLUDED_STRF_WATERFALL_SINK_H
...
namespace gr
{
  namespace strf
  {
     ...
     *
     * The file has a special header, so that the strf_waterfall Gnuplot
     * script to be able to plot it properly.
     *
     * \ingroup strf
     *
     */
    class STRF_API waterfall_sink : virtual public gr::sync_block
    {
    public:
...
#endif /* INCLUDED_STRF_WATERFALL_SINK_H */
