...
#ifndef INCLUDED_STRF_WATERFALL_SINK_IMPL_H
#define INCLUDED_STRF_WATERFALL_SINK_IMPL_H
...
namespace gr
{
  namespace strf
  {
    ...
    private:
      ...
      double d_pps;
      struct timeval d_tstart, tstart, tend;
...
#endif /* INCLUDED_STRF_WATERFALL_SINK_IMPL_H */
